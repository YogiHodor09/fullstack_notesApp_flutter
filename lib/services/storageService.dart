...
import '../model/storageItem/storageItem.dart';
...
class StorageService {
  ...
  Future<void> storeAccessToken(var accessToken) async {
    StorageService().writeSecureData(StorageItem('accessToken', accessToken));
    debugPrint('Stored token :: $accessToken');
  }

  Future<String?> readAccessToken() async {
    var token = await StorageService().readSecureData('accessToken');
    debugPrint('Present token :: $token');
    return token;
  }
}
